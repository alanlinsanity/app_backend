  ...
  const listings = [
    ...
    },
    {
      ...
      },
      {
        ...
        {
          postal: `${Math.floor(Math.random() * 2)}${Math.floor((Math.random() * 88888) + 10000)}`,
          district: (Math.floor(Math.random() * 27) + 1),
          address: "91 West Coast Drive",
          property_type: "HDB",
          size: (Math.floor(Math.random() * 1700) + 800),
          price: (Math.floor(Math.random() * 3000) + 2000),
          image: "https://www.urbanjourney.com/wp-content/uploads/2019/05/Screen-Shot-2019-05-20-at-3.11.48-PM.png",
          no_of_bedrooms: (Math.floor(Math.random() * 4) + 1),
